...
function ChargesExp () {
    return ( 
        <div className='container pt-5 my-3' style={{maxWidth:"1130px"}}>
            <div className='row'>
                <h1 className='h4 pb-3'>Charges explained</h1>
                <div className='col-6'>
                    <h1 className=' text-muted py-2' style={{fontSize:"16px"}}>Securities/Commodities transaction tax</h1>
                    ...
                    <h1 className=' text-muted py-2' style={{fontSize:"16px"}}>Transaction/Turnover Charges</h1>
                    ...
                    <h1 className=' text-muted py-2' style={{fontSize:"16px"}}>Call & trade</h1>
                    ...
                    <h1 className=' text-muted py-2' style={{fontSize:"16px"}}>Stamp charges</h1>
                    ...
                    <h1 className=' text-muted py-2' style={{fontSize:"16px"}}>NRI brokerage charges</h1>
                    ...
                    <h1 className=' text-muted py-2' style={{fontSize:"16px"}}>Account with debit balance</h1>
                    ...
                    <h1 className=' text-muted py-2' style={{fontSize:"16px"}}>Charges for Investor's Protection Fund Trust (IPFT) by NSE</h1>
                    <ul className='text-muted' style={{fontSize:"12px"}}>
                    ...
                    <h1 className=' text-muted py-2' style={{fontSize:"16px"}}>Margin Trading Facility (MTF)</h1>
                    <ul className='text-muted' style={{fontSize:"12px"}}>
                ...
                <div className='col-6'>
                    <h1 className=' text-muted py-2' style={{fontSize:"16px"}}>GST</h1>
                    ...
                    <h1 className=' text-muted py-2' style={{fontSize:"16px"}}>SEBI Charges</h1>
                    ...
                    <h1 className=' text-muted py-2' style={{fontSize:"16px"}}>DP (Depository participant) charges</h1>
                    ...
                    <h1 className=' text-muted py-2' style={{fontSize:"16px"}}>Pledging charges</h1>
                    <p className='text-muted' style={{fontSize:"12px"}}>₹30 + GST per pledge request per ISIN.</p>

                    <h1 className=' text-muted py-2' style={{fontSize:"16px"}}>AMC (Account maintenance charges)</h1>
                    <p className='text-muted' style={{fontSize:"12px"}}>Free for the first year on all new resident individual accounts.</p>
                    <p className='text-muted' style={{fontSize:"12px"}}>For BSDA demat account: Zero charges if the holding value is less than ₹4,00,000. To learn more about BSDA, <a href='#' className='text-decoration-none'>Click here</a></p>
                    <p className='text-muted' style={{fontSize:"12px"}}>For non-BSDA demat accounts: ₹300/year + 18% GST charged quarterly (90 days). To learn more about AMC, <a href='#' className='text-decoration-none'>Click here</a></p>

                    <h1 className=' text-muted py-2' style={{fontSize:"16px"}}>Corporate action order charges</h1>
                    ...
                    <h1 className=' text-muted py-2' style={{fontSize:"16px"}}>Off-market transfer charges</h1>
                    <p className='text-muted' style={{fontSize:"12px"}}>₹25 per transaction.</p>
                    
                    <h1 className=' text-muted py-2' style={{fontSize:"16px"}}>Physical CMR request</h1>
                    ...
                    <h1 className=' text-muted py-2' style={{fontSize:"16px"}}>Payment gateway charges</h1>
                    <p className='text-muted' style={{fontSize:"12px"}}>₹9 + GST (Not levied on transfers done via UPI)</p>

                    <h1 className=' text-muted py-2' style={{fontSize:"16px"}}>Delayed Payment Charges</h1>
                    <p className='text-muted ' style={{fontSize:"12px"}}>Interest is levied at 18% a year or 0.05% per day on the debit balance in your trading account. <a href='#' className='text-decoration-none'>Learn More.</a></p>

                    <h1 className=' text-muted py-2' style={{fontSize:"16px"}}>Trading using 3-in-1 account with block functionality</h1>
                    <ul className='text-muted' style={{fontSize:"12px"}}>
